...
export const CHAIN_IDS_TO_USDC_ADDRESSES = {
  ...
  [SupportedChainId.BASE_TESTNET]: '0x036CbD53842c5426634e7929541eC2318f3dCF7e',
}
...
export const CHAIN_IDS_TO_TOKEN_MESSENGER_ADDRESSES = {
  ...
  [SupportedChainId.BASE_TESTNET]: '0x9f3B8679c73C2Fef8b59B4f3444d4e156fb70AA5',
  [SupportedChainId.APTOS_TESTNET]: '',
}
...
export const CHAIN_IDS_TO_MESSAGE_TRANSMITTER_ADDRESSES = {
  ...
  [SupportedChainId.BASE_TESTNET]: '0x7865fAfC2db2093669d92c0F33AeEF291086BEFD',
  [SupportedChainId.APTOS_TESTNET]: '',
}
